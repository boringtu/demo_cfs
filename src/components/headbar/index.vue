...
.headbar
	...
	div(class="line_status" :class="{'onlineStatus': isOnLine === 1, 'offLineStatus': isOnLine === 2}" @click="chooseLineStatus")
		i(class="icon icon-item" :class="{'icon-online': isOnLine === 1, 'icon-afk': isOnLine === 2}") 
