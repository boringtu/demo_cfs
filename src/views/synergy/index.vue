...
.root
	...
	div(class="popup" v-if="isShowAddNewPop")
		.pop_cont
			h2.title {{popTitle}}
			.center_cont 
				input(type="text" v-model.trim="addGroupName" maxlength="20" @focus="saveBlock = false" class="add_group_input" :class="{'save_block': saveBlock}" @input="editGroupNameInput" @change="editGroupNameChange" name="groupname")
